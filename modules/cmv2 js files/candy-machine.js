...
export var CANDY_MACHINE_PROGRAM = new anchor.web3.PublicKey('cndy3Z4yapfJBmL3ShUp5exZKqR3z33thTzeNMm2gRZ');
var TOKEN_METADATA_PROGRAM_ID = new anchor.web3.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s');
export var awaitTransactionSignatureConfirmation = function (txid, timeout, connection, queryStatus) {
...
export var getCandyMachineState = function (anchorWallet, candyMachineId, connection) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, anchor.Program.fetchIdl(CANDY_MACHINE_PROGRAM, provider)];
            case 1:
                idl = _a.sent();
...
export var getCandyMachineCreator = function (candyMachine) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, anchor.web3.PublicKey.findProgramAddress([Buffer.from('candy_machine'), candyMachine.toBuffer()], CANDY_MACHINE_PROGRAM)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
export var mintOneToken = function (candyMachine, payer) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_p) {
        switch (_p.label) {
            case 0:
                ...
                return [4 /*yield*/, getAtaForMint(mint.publicKey, payer)];
            case 1:
                userTokenAccountAddress = (_p.sent())[0];
                if (!candyMachine.state.tokenMint) return [3 /*break*/, 3];
                return [4 /*yield*/, getAtaForMint(candyMachine.state.tokenMint, payer)];
            case 2:
                _a = (_p.sent())[0];
                return [3 /*break*/, 4];
            case 3:
            ...
            case 4:
                ...
                return [4 /*yield*/, candyMachine.program.provider.connection.getMinimumBalanceForRentExemption(MintLayout.span)];
            case 5:
                instructions = [
                    _c.apply(_b, [(_l.lamports = _p.sent(),
                            _l.programId = TOKEN_PROGRAM_ID,
                            _l)]),
                ...
                _m = {};
                return [4 /*yield*/, getNetworkToken(payer, candyMachine.state.gatekeeper.gatekeeperNetwork)];
            case 6:
                ...
                _o = {};
                return [4 /*yield*/, getNetworkExpire(candyMachine.state.gatekeeper.gatekeeperNetwork)];
            case 7:
            ...
            case 8:
                ...
                return [4 /*yield*/, getAtaForMint(mint_1, payer)];
            case 9:
            ...
            case 16:
                ...
                return [4 /*yield*/, sendTransactions(candyMachine.program.provider.connection, candyMachine.program.provider.wallet, [instructions, cleanupInstructions], [signers, []])];
