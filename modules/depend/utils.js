...
import { SystemProgram, TransactionInstruction, SYSVAR_RENT_PUBKEY, LAMPORTS_PER_SOL, } from '@solana/web3.js';
...
export var numberFormater = new Intl.NumberFormat('en-US', {
    style: 'decimal',
