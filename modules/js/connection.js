        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, sendTransactionWithRetry(connection, wallet, instructions[0], filteredSigners[0], 'single')];
                case 3:
                    id = _a.sent();
                    ids.push(id.txid);
                    stopPoint = 1;
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, sendTransactions(connection, wallet, instructions, filteredSigners, SequenceType.StopOnFailure, 'single')];
                case 5:
                    txs = (_a.sent()).txs;
...
export var sendTransactions = function (connection, wallet, instructionSet, signersSet, sequenceType, commitment, successCallback, failCallback, block) {
...
export var sendTransaction = function (connection, wallet, instructions, signers, awaitConfirmation, commitment, includesFeePayer, block) {
...
export function sendSignedTransaction(_a) {
                ...
                case 1:
                    ...
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(!done && getUnixTs() - startTime < timeout)) return [3 /*break*/, 2];
